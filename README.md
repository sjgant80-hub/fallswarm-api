...
HTTP API wrapping `@ai-native-solutions/fallswarm-sdk`.
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallswarm-api](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallswarm-api)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallswarm-api-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallswarm-api -- npx -y @ai-native-solutions/fallswarm-api-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallswarm-api-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallswarm-api
- **Live URL**: https://sjgant80-hub.github.io/fallswarm-api/
- **Source**: https://github.com/sjgant80-hub/fallswarm-api
